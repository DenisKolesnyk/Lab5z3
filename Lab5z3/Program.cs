...
namespace _3
{
    ...
    abstract class Clothes
    {
        ...
        protected Clothes(int s, double v, string c)
        {
            sizeClothes = s;
            price = v;
            color = c;
    ...
    class Atelier
    {
        public void dressMan()
        {
            ...
            IMenswear[] wear = { new TShirt(38, 790, "червона"), new Pants(43, 750, "чорні"), new Necktie(8, 199.99, "чорний") };
        ...
        public void dressWoman()
        {
            ...
            IWomenswear[] wear = { new TShirt(35, 850, "біла"), new Pants(38, 749.99, "сині"), new Skirt(6, 700, "чорна") };
